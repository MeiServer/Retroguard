...
abstract public class MdFd extends TreeItem {
	 ...
	 */
	public MdFd(final TreeItem parent, final boolean isSynthetic, final String name, final String descriptor,
	 ...
	 * @param descPattern
	 */
	public boolean isWildcardMatch(final String namePattern, final String descPattern) {

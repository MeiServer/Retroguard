...
public interface ClassConstants {
	 ...
	 */
	public static final String[] KNOWN_ATTRS = { ClassConstants.ATTR_Code, ClassConstants.ATTR_ConstantValue,
			ClassConstants.ATTR_Exceptions, ClassConstants.ATTR_LineNumberTable, ClassConstants.ATTR_SourceFile,
			ClassConstants.ATTR_LocalVariableTable, ClassConstants.ATTR_InnerClasses, ClassConstants.ATTR_Synthetic,
			ClassConstants.ATTR_Deprecated, ClassConstants.ATTR_Signature, ClassConstants.ATTR_LocalVariableTypeTable,
			ClassConstants.ATTR_RuntimeVisibleAnnotations, ClassConstants.ATTR_RuntimeInvisibleAnnotations,
			ClassConstants.ATTR_RuntimeVisibleParameterAnnotations,
			ClassConstants.ATTR_RuntimeInvisibleParameterAnnotations, ClassConstants.ATTR_AnnotationDefault,
			ClassConstants.ATTR_EnclosingMethod, ClassConstants.ATTR_StackMapTable,
			ClassConstants.ATTR_BootstrapMethods, ClassConstants.ATTR_NestHost, ClassConstants.ATTR_NestMembers, };

	/**
	 * List of required attributes
	 */
	public static final String[] REQUIRED_ATTRS = { ClassConstants.ATTR_Code, ClassConstants.ATTR_ConstantValue,
			ClassConstants.ATTR_Exceptions, ClassConstants.ATTR_InnerClasses, ClassConstants.ATTR_Synthetic,
			ClassConstants.ATTR_StackMapTable, ClassConstants.ATTR_BootstrapMethods, ClassConstants.ATTR_NestHost,
	 ...
	 */
	public static final String[] KNOWN_OPTIONS = { ClassConstants.OPTION_Application, ClassConstants.OPTION_Applet,
			ClassConstants.OPTION_Serializable, ClassConstants.OPTION_RMI, ClassConstants.OPTION_Enumeration,
			ClassConstants.OPTION_Annotations, ClassConstants.OPTION_RuntimeAnnotations,
			ClassConstants.OPTION_MapClassString, ClassConstants.OPTION_DigestSHA, ClassConstants.OPTION_DigestMD5,
			ClassConstants.OPTION_LineNumberDebug, ClassConstants.OPTION_Repackage, ClassConstants.OPTION_Generic, };

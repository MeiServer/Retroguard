...
abstract public class ClassItemInfo implements ClassConstants {
	 ...
	 * @param cf
	 */
	protected ClassItemInfo(final ClassFile cf) {
		this.cf = cf;
	}
	 ...
	 * @throws ClassFileException
	 */
	protected void read(final DataInput din) throws IOException, ClassFileException {
		...
		for (int i = 0; i < u2attributesCount; i++) {
			final AttrInfo at = AttrInfo.create(din, this.cf,
					this instanceof FieldInfo ? AttrSource.FIELD : AttrSource.METHOD);
